...
export default function SubmitStoryHero() {
    return (
            ...
            <div className="relative sm:absolute sm:top-1/2 sm:left-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2 max-w-[1400px] w-full px-4 sm:px-6 md:px-[40px] lg:px-[60px] flex items-center justify-between gap-6 sm:gap-8 lg:gap-[60px] z-[2] lg:flex-row flex-col lg:text-left text-center">
                ...
                <div className="flex-1 max-w-[600px] w-full">
                    ...
                    <h1 className="text-2xl sm:text-[32px] md:text-[42px] lg:text-[48px] xl:text-[58px] font-extrabold text-[#383838] leading-[1.2] mb-4 sm:mb-6">
                        Your place. Your people. Your perspective.
                    </h1>

                    {/* Description */}
                    <p className="text-sm sm:text-base text-slate-600 leading-[1.7] max-w-[520px] mx-auto lg:mx-0">
                        Have a moment, tradition, or insight to share about your culture or region? Geofragy invites you to contribute your story and become part of a global movement of cultural connection.
                    </p>
                </div>

                {/* Right Content - Image Section */}
                <div className="flex-1 relative flex items-center justify-center min-h-[300px] sm:min-h-[400px] lg:min-h-[500px] w-full">
                    {/* Blur Circle Behind Man */}
                    <div className="absolute w-[250px] h-[250px] sm:w-[350px] sm:h-[350px] md:w-[450px] md:h-[450px] bg-[#175883] rounded-full z-[1] right-0 sm:right-[20px] md:right-[50px] top-1/2 -translate-y-1/2" />
                    ...
                    {/* 100+ Stories Badge */}
                    <div className="absolute top-[40px] right-[20px] sm:top-[20px] sm:right-[30px] z-[3] w-[80px] h-[80px] sm:w-[110px] sm:h-[110px] md:w-[140px] md:h-[140px]">
                        <Image
                            src="/images/green.png"
                            alt="100+ stories submitted"
                            width={140}
                            height={140}
                            className="w-full h-full"
                        />
