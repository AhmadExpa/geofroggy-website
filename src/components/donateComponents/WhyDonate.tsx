...
const offerCards: OfferCard[] = [
    {
        id: 1,
        icon: "/images/donate/icon1.png",
        title: "Connect Across Cultures",
        description: "Engage with a vibrant global community, exchanging stories and perspectives that help foster understanding and unity.",
    },
    {
        id: 2,
        icon: "/images/donate/icon2.png",
        title: "Discover New Perspectives",
        description: "Browse personal narratives, images, and videos that explore the beauty and complexity of our world's cultures.",
    },
    {
        id: 3,
        icon: "/images/donate/icon3.png",
        title: "Share Your Story",
        description: "Whether it's a travel tale, local tradition, or personal milestone – your story helps us all see the world a little more clearly.",
    },
    {
        id: 4,
        icon: "/images/donate/icon4.png",
        title: "Share Your Story",
        description: "Whether it's a travel tale, local tradition, or personal milestone – your story helps us all see the world a little more clearly.",
    },
];
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="text-center mb-12">
                    ...
                    <p className="text-gray-600 text-base md:text-lg max-w-3xl mx-auto leading-relaxed">
                        Lorem ipsum dolor sit amet consectetur. Nulla lectus consectetur purus egestas. Congue tortor viverra ut amet feugiat in mattis scelerisque.
                    </p>
                </div>
